...
export function Checkbox({ checked, onChange, label, tone = 'primary', className, ...props }: CheckboxProps) {
  const toneClasses = tone === 'danger'
    ...
    : 'border-gray-300 hover:border-gray-400 checked:bg-[#9181bd] checked:border-[#9181bd] focus:ring-[#9181bd]/20 dark:border-white/15 dark:hover:border-white/30 dark:checked:bg-[#9181bd] dark:checked:border-transparent'
  return (
